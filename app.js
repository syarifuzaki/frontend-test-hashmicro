  ...
  setup() {
    ...
    const projects = ref([
      ...
      },
      {
        ...
        tasksCompleted: 12,
        totalTasks: 40,
        team: ["John Doe", "Robert Johnson", "Linda Taylor"],
      },
      {
        id: 3,
        ...
        tasksCompleted: 0,
        totalTasks: 15,
        team: ["Jane Smith", "Michael Brown", "Emily Davis"],
      },
      {
        id: 4,
    ...
    const tasks = ref([
      {
        ...
        description: "Create wireframe and mockup designs for the new homepage",
      ...
      },
      {
        ...
        description: "Fix the responsive navigation menu bug on mobile devices",
        project: "Website Redesign",
        assignedTo: "John Doe",
        dueDate: "2025-03-10",
        status: "In Progress",
